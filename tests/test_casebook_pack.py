"""Regression checks for the ember-move-opening-lab casebook."""
...
from casebook.harness import assert_expected, ember_move_opening_lab_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(ember_move_opening_lab_summary(), assert_expected())
